            ...
            child: Column(
              children: [
                const Device(
                  ...
                  disabledGradientBeginColor: Color(0xff4d0a6d),
                  disabledGradientEndColor: Color(0xff8a5bbb),
                ),
                const Device(
                  title: 'Aircon',
                  subTitle: 'Study Room',
                  icon: Icons.ac_unit,
                  color: Colors.cyan,
                  gradientBeginColor: Color(0xffc8cde9),
                  gradientEndColor: Color(0xff5b73c4),
                ...
                const Device(
                  ...
                  gradientBeginColor: Color(0xff0cc7a3),
                  gradientEndColor: Color(0xff086f6d),
                  disabledGradientBeginColor: Color(0xffe0e0e0),
                  disabledGradientEndColor: Color(0xffc8c8c8),
                ),
                CheckboxListTile(
